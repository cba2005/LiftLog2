...
public class CalendarAdapter extends BaseAdapter {
    ...
    public CalendarAdapter(Context c, Calendar monthCalendar) {
        ...
        Log.v("CalendarAdapter", "month: " + month.get(Calendar.MONTH));
        Log.v("CalendarAdapter", "day: " + month.get(Calendar.DAY_OF_MONTH));
        Log.v("CalendarAdapter", "year: " + month.get(Calendar.YEAR));
