 ...
 */
public class AddEventKnownDateDialog extends DialogFragment {
    private MyActivity activity;
    private Button timeButton, cancelButton, addEventButton;
    ...
    public AddEventKnownDateDialog(MyActivity activity, Calendar c)
    {
    ...
    public Dialog onCreateDialog(final Bundle savedInstanceState) {
        ...
        dialog.setContentView(R.layout.add_known_date_item);
